	 ...
	 var methods = {
		...
		_custom: function(field, rules, i, options) {
			...
			if(rule["regex"]) {
				 var ex=rule.regex;
					...
					if(customRule === "formattedThreeDecimalsOnly" || customRule === "formattedTwoDecimalsOnly" || customRule === "formattedNumbersOnly")
					{
						var unformattedNumber = getUnformatedNumber(field.val());
						var isValidUnFormattedAmount = pattern.test(unformattedNumber);
						if(!isValidUnFormattedAmount)
						{
					...
					else if (!pattern.test(field.val())) return options.allrules[customRule].alertText;
		...
		*/
		_max: function(field, rules, i, options) {
			...
			var len = parseFloat(getUnformatedNumber(field.val()));
